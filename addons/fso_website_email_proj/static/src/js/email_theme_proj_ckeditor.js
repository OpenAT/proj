...
(function () {
    ...
    openerp.website.RTE = openerp.website.RTE.extend({
        _config: function () {
            ...
            config.colorButton_colors = 'ffffff,000000,666666,E72D30,ECEAE3';
            ...
            config.stylesSet = [
                ...
                {name: 'p Klein', element: 'p', attributes: { 'class': 'proj_small' } },
                {name: 'p Winzig', element: 'p', attributes: { 'class': 'proj_tiny' } },
                {name: 'H1', element: 'h1'},
                {name: 'H2', element: 'h2'},
                {name: 'H3', element: 'h3'},
                {name: 'H4', element: 'h4'},
